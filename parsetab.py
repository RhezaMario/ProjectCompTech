...
_lr_productions = [
  ...
  ('command -> PRINT print_list optend','command',3,'p_command_print','parsers.py',21),
  ('command -> ECHO print_list optend','command',3,'p_command_print','parsers.py',22),
  ...
  ('expression -> expression PLUS expression','expression',3,'p_expression_binop','parsers.py',46),
  ('expression -> expression MINUS expression','expression',3,'p_expression_binop','parsers.py',47),
  ('expression -> expression TIMES expression','expression',3,'p_expression_binop','parsers.py',48),
  ('expression -> expression DIVIDE expression','expression',3,'p_expression_binop','parsers.py',49),
  ('expression -> expression MODULO expression','expression',3,'p_expression_binop','parsers.py',50),
  ('comparison -> expression LTE expression','comparison',3,'p_expression_relop','parsers.py',56),
  ('comparison -> expression GTE expression','comparison',3,'p_expression_relop','parsers.py',57),
  ('comparison -> expression LT expression','comparison',3,'p_expression_relop','parsers.py',58),
  ('comparison -> expression GT expression','comparison',3,'p_expression_relop','parsers.py',59),
  ('comparison -> expression ET expression','comparison',3,'p_expression_relop','parsers.py',60),
  ('comparison -> expression NE expression','comparison',3,'p_expression_relop','parsers.py',61),
  ('expression -> NUMBER','expression',1,'p_expression_number','parsers.py',66),
  ('expression -> LPAREN expression RPAREN','expression',3,'p_expression_group','parsers.py',70),
  ('command -> ID EQUALS expression optend','command',4,'p_command_def_id','parsers.py',74),
  ('expression -> ID','expression',1,'p_expression_id','parsers.py',78),
  ('command -> IF LPAREN comparison RPAREN LBRACKET statement_list RBRACKET','command',7,'p_if_statement','parsers.py',83),
  ('command -> IF LPAREN comparison RPAREN LBRACKET statement_list RBRACKET ELSE LBRACKET statement_list RBRACKET','command',11,'p_if_statement','parsers.py',84),
  ('statement_list -> statement_list statement','statement_list',2,'p_statement_list','parsers.py',91),
  ('statement_list -> statement','statement_list',1,'p_statement_list','parsers.py',92),
  ('statement -> command','statement',1,'p_statement','parsers.py',100),
  ('statement -> <empty>','statement',0,'p_statement','parsers.py',101),
  ('command -> WHILE LPAREN comparison RPAREN LBRACKET statement_list RBRACKET','command',7,'p_command_while','parsers.py',110),
  ('optend -> SEMICOLON','optend',1,'p_optend','parsers.py',121),
  ('optend -> <empty>','optend',0,'p_optend','parsers.py',122),
]
